...
rm -f _site/*.log
bundle exec htmlproofer ./_site --disable-external --url-ignore "#,/support/knowledgecenter/js/kc/globaltopic.js,/support/knowledgecenter/js/kc/themes/css/globaltopic.css" --file_ignore ["./_site/MFPSamples/blog/*"] --log-level :debug
