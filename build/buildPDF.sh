...
cp -R _site/pdf/tutorials/en/production-integration/7.1/application-scanning.pdf ../generated-pdf/release71/tutorials/en/application-scanning.pdf
# copy the index file
...
cp -R _site/pdf/tutorials/en/application-scanning.pdf ../generated-pdf/release70/tutorials/en/application-scanning.pdf
# copy the index file
