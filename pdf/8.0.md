...
* [Create a {{ site.data.keys.mf_server }} instance using the Mobile Foundation on IBM Cloud service](tutorials/en/foundation/8.0/bluemix/using-mobile-foundation.pdf)
