...
### [Upgrading to to IBM MobileFirst Foundation v8.0](../upgrading.pdf)
Learn about product changes to prepare and plan for the migration of your MobileFirst applications.

* [Migration Cookbook](../upgrading/migration-cookbook.pdf)
* [Migrating from earlier releases](../upgrading.pdf)
    * [Migrating client application](../upgrading/migrating-client-applications.pdf)
        * [Migrating existing Cordova and Hybrid applications](../upgrading/migrating-client-applications/cordova.pdf)
        * [Migrating existing native iOS applications](../upgrading/migrating-client-applications/ios.pdf)
        * [Migrating existing native Android applications](../upgrading/migrating-client-applications/android.pdf)
        * [Migrating existing native Windows applications](../upgrading/migrating-client-applications/windows.pdf)
    * [Migrating existing adapters to work under MobileFirst Server v8.0](../upgrading/migrating-adapters.pdf)
    * [Migrating push notifications](../upgrading/migrating-push-notifications.pdf)
    * [Migrating apps storing mobile data in Cloudant with IMFData or Cloudant SDK](../upgrading/migrating-data.pdf)
...
### [Developing Applications](tutorials/en/foundation/8.0/using-the-mfpf-sdk.pdf)
...
### [MobileFirst Quality Assurance]({{site.baseurl}}/tutorials/en/quality-assurance/8.0.pdf)
