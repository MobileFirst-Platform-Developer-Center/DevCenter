...
*   [Deploying IBM Mobile Foundation for Developers 8.0 on IBM Cloud Private](tutorials/en/foundation/8.0/bluemix/mobilefirst-community-edition-on-icp.pdf)
*   [Setting up MobileFirst Server on IBM Cloud Private](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-icp.pdf)
    *   [Setting up MobileFirst Application Center on IBM Cloud Private](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-icp/mobilefirst-appcenter-on-icp.pdf)
    *   [Monitoring Mobile Foundation in IBM Cloud Private (ICP)](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-icp/monitoring-mobilefirst-on-icp.pdf)
    *   [Logging and Tracing in IBM Cloud Private](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-icp/logging-tracing-on-icp.pdf)
    *   [Analyzing MobileFirst log messages in IBM Cloud Private](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-icp/analyzing-mobilefirst-logs-on-icp.pdf)
    *   [Setting up Mobile Foundation with Oracle database on IBM Cloud Private](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-icp/mobilefirst-server-on-icp-using-oracle.pdf)
*   [Setting up Mobile Foundation on IBM Cloud Kubernetes Cluster using Helm](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-kubernetes-using-helm.pdf)    
*   [Setting Up MobileFirst Server on IBM Cloud Kubernetes Cluster using scripts](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-on-kubernetes-using-scripts.pdf)
    *   [Setting Up MobileFirst Appcenter on IBM Cloud Kubernetes Cluster using scripts](tutorials/en/foundation/8.0/bluemix/mobilefirst-server-using-kubernetes/mobilefirst-appcenter-on-kubernetes-using-scripts.pdf)
