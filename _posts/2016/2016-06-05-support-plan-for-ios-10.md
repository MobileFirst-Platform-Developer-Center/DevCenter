...
For those customers who have iOS apps developed using IBM Worklight Foundation 6.2 or earlier releases, and intend to have their app running on iOS 10, an upgrade to a later release such as  [MobileFirst Foundation 8.0]({{site.baseurl}}/blog/2016/06/17/ibm-releases-next-generation-of-mobilefirst-foundation-built-for-hybrid-cloud/) is required. Talk to your IBM representative about how we can help.
