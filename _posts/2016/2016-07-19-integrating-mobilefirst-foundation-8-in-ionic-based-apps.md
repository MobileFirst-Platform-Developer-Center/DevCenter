...
To get up &amp; running with the MobileFirst Server you can either use the [Mobile Foundation Bluemix service]({{site.baseurl}}/tutorials/en/foundation/8.0/ibmcloud/using-mobile-foundation/) or [download the DevKit Installer]({{site.baseurl}}/downloads) for an on-prem installation.
