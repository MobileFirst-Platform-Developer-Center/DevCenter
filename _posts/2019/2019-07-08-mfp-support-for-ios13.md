...
Apps built with older Xcode(10.1 and above) can be still submitted to app Store. The minimum iOS SDK level is 12.1, should be used in any newer or existing apps. Refer [here](https://developer.apple.com/ios/submit/) for details.  
...
iOS 13 compatibility tests are planned for following:
