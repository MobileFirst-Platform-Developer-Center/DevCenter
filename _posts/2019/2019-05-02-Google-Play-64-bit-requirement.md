...
One of the [known limitations](https://mobilefirstplatform.ibmcloud.com/tutorials/en/foundation/8.0/product-overview/release-notes/known-issues-limitations/#fips-104-2-feature-limitations) of MobileFirst is the restricted availability of FIPS 140-2 support for JSONStore data in 64-bit mode applications on Android.
>**Note:** This limitation is not applicable if you are on SDK level Android Native [ibmmobilefirstplatformfoundationjsonstore v8.0.2019072505](https://search.maven.org/artifact/com.ibm.mobile.foundation/ibmmobilefirstplatformfoundationjsonstore/8.0.2019072505/aar) or above, Cordova [cordova-plugin-mfp-jsonstore v8.0.2019072908](https://www.npmjs.com/package/cordova-plugin-mfp-jsonstore) or above for MFP v8 and [iFix 7.1.0.0-MFPF-IF201907301558 ](http://www.ibm.com/support/fixcentral/quickorder?product=ibm%2FOther+software%2FIBM+MobileFirst+Platform+Foundation&fixids=7.1.0.0-MFPF-IF201907301558&source=SAR) or above for MFP v7.1

## Backward compatibility
>**Note:**This is not applicable if you are on SDK level Android Native [ibmmobilefirstplatformfoundationjsonstore v8.0.2019072505](https://search.maven.org/artifact/com.ibm.mobile.foundation/ibmmobilefirstplatformfoundationjsonstore/8.0.2019072505/aar) or above, Cordova [cordova-plugin-mfp-jsonstore v8.0.2019072908](https://www.npmjs.com/package/cordova-plugin-mfp-jsonstore) or above for MFP v8 and [iFix 7.1.0.0-MFPF-IF201907301558 ](http://www.ibm.com/support/fixcentral/quickorder?product=ibm%2FOther+software%2FIBM+MobileFirst+Platform+Foundation&fixids=7.1.0.0-MFPF-IF201907301558&source=SAR) or above for MFP v7.1
...
>**Note** : Below steps are needed if you are on iFix level [7.1.0.0-MFPF-IF201907301558 ](http://www.ibm.com/support/fixcentral/quickorder?product=ibm%2FOther+software%2FIBM+MobileFirst+Platform+Foundation&fixids=7.1.0.0-MFPF-IF201907301558&source=SAR) or above .
