---
title: MobileFirst Foundation iFix 8.0.0.0-MFPF-IF201805071746 released
date: 2018-05-10
version:
- 8.0
tags:
...
**PI97298** MFP DEVICES (GET) API DOES NOT WORK CONSISTENTLY WHEN USING 'QUERY' PARAMETER<br/>
**PI97147** REDOS SECURITY VULNERABILITY DISCOVERED INCORDOVA-PLUGIN-GLOBALIZATION<br/>
**PI97119** ISSUE WITH USING CUSTOM JAVA CLASSES FROM JAVASCRIPT ADAPTER<br/>
