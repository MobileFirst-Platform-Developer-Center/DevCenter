...
3. В проекте Cordova выберите файл **config.xml** и измените значение `<mfp:server ... url=" "/>` свойств **protocol**, **host** и **port** с учетом параметров {{ site.data.keys.mf_server }}.
