...
In diesem Abschnitt sind die häufig zur IBM Mobile Foundation gestellten Fragen aufgeführt.

<div class="panel-group accordion" id="mfp-product-faqs" role="tablist">
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq1">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq1" aria-expanded="true" aria-controls="collapse-mfp-faq1"><b>1.	Welche Supportrichtlinie gibt es für Mobile Foundation Version 8.0?</b></a>
            </h4>
        </div>
...
.</p>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq2">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq2" aria-expanded="true" aria-controls="collapse-mfp-faq2"><b>2. Wo erhalte ich Informationen zu vorläufigen Fixes und CD-Updates für die Mobile Foundation?</b></a>
            </h4>
        </div>
        <div id="collapse-mfp-faq2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mfp-faq2">
            <div class="panel-body">
                  <p>Eine Liste aller vorläufigen Fixes und CD-Updates, die für Mobile Foundation Version 8.0 freigegeben wurden, finden Sie <a href="https://mobilefirstplatform.ibmcloud.com/blog/2018/05/18/8-0-master-ifix-release/" target="_blank">hier</a>.</p>
            </div>
        </div>      
    </div>
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq3">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq3" aria-expanded="true" aria-controls="collapse-mfp-faq3"><b>3. Welche Features wurden mit den CD-Updates für Mobile Foundation Version 8.0 freigegeben?</b></a>
            </h4>
        </div>
        <div id="collapse-mfp-faq3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mfp-faq3">
            <div class="panel-body">
                  <p>Eine Liste der mit den CD-Updates für Mobile Foundation Version 8.0 freigegebenen Features finden Sie <a href="{{site.baseurl}}/tutorials/en/foundation/8.0/product-overview/release-notes/interim-fixes/">hier</a>.</p>
            </div>
        </div>      
    </div>
   <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq4">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq4" aria-expanded="true" aria-controls="collapse-mfp-faq4"><b>4. Wo finde ich weitere Informationen zur IBM Mobile Foundation für IBM Cloud Private (ICP)?</b></a>
            </h4>
        </div>
