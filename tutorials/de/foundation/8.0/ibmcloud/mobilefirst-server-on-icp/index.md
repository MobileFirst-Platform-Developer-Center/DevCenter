...
| mfpserver | adminClientSecret | Geheimer Clientschlüssel für Verwaltung | Geben Sie den Namen des erstellten geheimen Clientschlüssels an (siehe Punkt 6 unter [Voraussetzungen](#Prerequisites)). |
|  | pushClientSecret | Geheimer Clientschlüssel für Push | Geben Sie den Namen des erstellten geheimen Clientschlüssels an (siehe Punkt 6 unter [Voraussetzungen](#Prerequisites)). |
