...
<div class="panel-group accordion" id="scripts2" role="tablist" aria-multiselectable="false">
    <div class="panel panel-default">
        ...
        <div id="collapse-step-foundation-1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="setupCordova">
            <div class="panel-body">
            <b>args</b> 폴더에는 스크립트를 실행하는 데 필요한 인수가 포함된 구성 파일 세트가 들어 있습니다. <b>args</b> 폴더에서 비어 있는 템플리트 파일과 인수에 대한 설명을 찾거나 <b>recorded-args</b> 폴더에 대화식 스크립트 실행을 게시할 수 있습니다. 파일은 다음과 같습니다.<br/>
              ...
              dashDB 인스턴스를 설정한 후 필요한 인수를 제공하십시오. 
...
{% endhighlight %}
                  ...
                  <li><b>prepareserver.sh - {{site.data.keys.mf_server }} 준비</b><br />
                    {{site.data.keys.mf_server }}를 빌드하여 Bluemix에 Cloud Foundry 애플리케이션으로 푸시하려면 <b>prepareserver.sh</b> 스크립트를 실행하십시오. 로그인한 조직과 공간에서 모든 Cloud Foundry 애플리케이션과 해당 URL을 보려면 <code>cf apps</code>를 실행하십시오.<br/>
