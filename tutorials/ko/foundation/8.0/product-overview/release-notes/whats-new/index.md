    ...
    <div class="panel panel-default">
        ...
        <div id="collapse-mobilefirst-server" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mobilefirst-server">
            <div class="panel-body">
                ...
                <p>이제 Ant 태스크를 사용하거나 서버 구성 도구를 사용하여 서버 팜에서 {{site.data.keys.mf_server }} 컴포넌트를 설치할 수 있습니다. 자세한 정보는 다음 주제를 참조하십시오. </p>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse-mobilefirst-analytics" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mobilefirst-analytics">
            <div class="panel-body">
                ...
                <p>일부 이벤트 유형은 {{site.data.keys.mf_analytics_server }}의 이전 버전과 V8.0 간에 변경되었습니다. 이 변경으로 인해 이전에 서버 구성 파일에 구성된 JNDI 파일을 새 이벤트 유형으로 변환해야 합니다.</p>
            </div>
        </div>
    </div>
