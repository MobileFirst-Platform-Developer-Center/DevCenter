...
Con el propósito de probar la funcionalidad del adaptador, utilice el mandato `mfpdev adapter call` para llamar a adaptadores Java o JavaScript desde la línea de mandatos.
Puede ejecutar el mandato de forma interactiva o de forma directa. A continuación se muestra un ejemplo de utilización de la modalidad directa:
