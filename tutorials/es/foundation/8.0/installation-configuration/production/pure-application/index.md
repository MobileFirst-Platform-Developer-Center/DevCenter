...
| Nodo | Componentes | 
|------|------------|
| MobileFirst Platform Server | **Servidor de perfil de Liberty**<br/>Instalación del servidor de perfil de WebSphere Application Server Liberty.<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>{{ site.data.keys.mf_server }} Configuración web de administración, incluida {{ site.data.keys.mf_console }}.<br/>**MFP Server Runtime Deployment**<br/>Configuración raíz de contexto de tiempo de ejecución.<br/><br/>**MFP Server Application**<br/>{{ site.data.keys.product_adj }} aplicación que se va a añadir al despliegue.<br/><br/>**MFP Server Adapter**<br/>. Un adaptador que se va a añadir al despliegue.<br/><br/>**despliegue de adaptador de aplicación de MFP Server**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración de MobileFirst.<br/><br/>**MFP Runtime DB**<br/>{{ site.data.keys.product }} instalación del esquema de base de datos de tiempo de ejecución<br/><br/>**Default add disk**<br/>Configuración del tamaño de disco. | 
...
| MobileFirst Platform Server | **Servidor de perfil de Liberty**<br/>Instalación del servidor de perfil de WebSphere Application Server Liberty.<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>{{ site.data.keys.mf_server }} Aplicación web de administración, incluida {{ site.data.keys.mf_console }}.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración raíz de contexto de tiempo de ejecución.<br/><br/>**MFP Server Application**<br/>{{ site.data.keys.product_adj }} aplicación que se va a añadir al despliegue.<br/><br/>**MFP Server Adapter**<br/>Un adaptador que se va a añadir al despliegue.<br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}.<br/><br/>**Base Scaling Policy**<br/>Política de escalado de VM: número de VM. | 
| MobileFirst Platform DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**MFP Administration DB**<br/>{{ site.data.keys.product_adj }} instalación del esquema de base de datos de administración.<br/><br/>**MFP Runtime DB**<br/>{{ site.data.keys.product }} instalación del esquema de base de datos de tiempo de ejecución<br/><br/>**Default add disk**<br/>Configuración del tamaño de disco. | 
...
| Nodo | Componentes | 
|------|------------|
| MobileFirst Platform Server | **Servidor autónomo**<br/>Instalación del servidor de perfil completo de WebSphere Application Server.<br/><br/>Restricción:<br/>no modifique los valores de los siguientes atributos del componente: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si modifica alguno de estos atributos, el despliegue de patrones basados en esta plantilla fallará.<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>{{ site.data.keys.mf_server }} Aplicación web de administración, incluida {{ site.data.keys.mf_console }}.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración raíz de contexto de tiempo de ejecución.<br/><br/>**{{ site.data.keys.product_adj }} App**<br/>{{ site.data.keys.product_adj }} aplicación que se va a añadir al despliegue.<br/><br/>**{{ site.data.keys.product_adj }} Adapter**<br/>{{ site.data.keys.product_adj }} adaptador que se va a añadir al despliegue.<br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**MFP Administration DB**<br/>{{ site.data.keys.product_adj }} instalación del esquema de base de datos de administración.<br/><br/>**MFP Runtime DB**<br/>{{ site.data.keys.product }} instalación del esquema de base de datos de tiempo de ejecución<br/><br/>**Default add disk**<br/>Configuración del tamaño de disco. | 
...
|------|------------|
| IHS Server | **IBM HTTP servers**<br/>Instalación de IBM HTTP Server.<br/><br/>**MFP IHS Configuration**<br/>Configuración automática de IBM HTTP Server. | 
| MobileFirst Platform Server | **Servidor autónomo**<br/>Instalación del servidor de perfil completo de WebSphere Application Server.<br/><br/>Restricción: no modifique los valores de los siguientes atributos del componente: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si modifica alguno de estos atributos, el despliegue de patrones basados en esta plantilla fallará.<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>{{ site.data.keys.mf_server }} Aplicación web de administración, incluida {{ site.data.keys.mf_console }}.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración de raíz de contexto de tiempo de ejecución.<br/><br/>**{{ site.data.keys.product_adj }} App**<br/>{{ site.data.keys.product_adj }} aplicación que se va a añadir al despliegue.<br/><br/>**{{ site.data.keys.product_adj }} Adapter**Un adaptador que se va a añadir al despliegue.<br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}.<br/><br/>**Base Scaling Policy**<br/>Política de escalado de VM: número de VM. | 
| MobileFirst Platform DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**MFP Administration DB**<br/>{{ site.data.keys.product_adj }} instalación del esquema de base de datos de administración.<br/><br/>**MFP Runtime DB**<br/>{{ site.data.keys.product }} instalación del esquema de base de datos de tiempo de ejecución<br/><br/>**Default add disk**<br/>Configuración del tamaño de disco. | 
...
|------|------------|
| IHS Server | **IBM HTTP servers**<br/>Instalación de IBM HTTP Server.<br/><br/>**MFP IHS Configuration**<br/>Configuración automática de IBM HTTP Server. | 
| DmgrNode | **Gestor de despliegue**<br/>Instalación del gestor de despliegue de WebSphere Application Server.<br/><br/>Restricción: no modifique los valores de los siguientes atributos del componente: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si modifica alguno de estos atributos, el despliegue de patrones basados en esta plantilla fallará.<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>{{ site.data.keys.mf_server }} Aplicación web de administración, incluida {{ site.data.keys.mf_console }}.<br/><br/>**MFP Runtime**<br/>Archivo WAR de tiempo de ejecución.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración raíz de contexto de tiempo de ejecución.<br/><br/>**MFP Application**<br/>{{ site.data.keys.product_adj }} aplicación que se va a añadir al despliegue.<br/><br/>**MFP Adapter**<br/>Un adaptador que se va a añadir al despliegue.<br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**MFP Administration DB**<br/>{{ site.data.keys.product_adj }} instalación del esquema de base de datos de administración.<br/><br/>**MFP Runtime DB**<br/>{{ site.data.keys.product }} instalación del esquema de base de datos de tiempo de ejecución<br/><br/>**Default add disk**<br/>Configuración del tamaño de disco. | 
| CustomNode | **Nodos personalizados**<br/>Detalles de celdas y nodos de los servidores de WebSphere Application Server Network Deployment.<br/><br/>Restricción: no modifique los valores de los siguientes atributos del componente:{::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si modifica alguno de estos atributos, el despliegue de patrones basados en esta plantilla fallará.<br/><br/>**MFP Open Firewall Ports for WAS**<br/>Puertos que deben estar abiertos para habilitar la conexión con el servidor de bases de datos y con el servidor LDAP.<br/><br/>**Base scaling policy**<br/>Número de instancias de máquina virtual necesarias para la topología elegida. | 
...
| Nodo | Componentes |
|------|------------|
| MFP AppCenter DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**Default add disk**<br/>Configuración de tamaño de disco. | 
| MFP AppCenter Server | **Servidor de perfil de Liberty**<br/>Instalación del servidor de perfil de WebSphere Application Server Liberty.<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Application Center**<br/>Este paquete de scripts configura el servidor de {{ site.data.keys.mf_app_center }} en un perfil completo de WebSphere Application Server o servidor de perfil de WebSphere Application Server Liberty. | 
...
|------|------------|
| MFP AppCenter DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**Default add disk**<br/>Configuración de tamaño de disco. | 
| MFP AppCenter Server | **Servidor autónomo**<br/>Instalación del servidor de perfil completo de WebSphere Application Server.<br/><br/>Restricción: no modifique los valores de los siguientes atributos del componente: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si modifica algunos de estos atributos, el despliegue de patrones basados en esta plantilla fallará.<br/><br/>**MFP WAS SDK Level**<br/>La finalidad de este script es definir el nivel de SDK necesario para el SDK predeterminado para el perfil de WAS<br/><br/>**MFP Server Prerequisite**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }}, incluidos SSL y Ant.<br/><br/>**MFP Server Application Center**<br/>Este paquete de scripts configura el servidor de {{ site.data.keys.mf_app_center }} en un perfil completo de WebSphere Application Server o servidor de perfil de WebSphere Application Server Liberty. | 
...
| HEAP\_MIN\_SIZE | Solo perfil completo de WebSphere Application Server.<br/><br/>Dependiendo de la cantidad de datos de análisis que se generan, se necesita más memoria para manejar más datos. Defínalo para permitir un tamaño mínimo de almacenamiento dinámico mayor para el perfil completo de WebSphere Application Server. Asegúrese de que el tamaño de memoria especificado en el componente Core OS de {{ site.data.keys.mf_analytics }} es mayor. Se recomienda establecer el mismo valor que HEAP_MAX_SIZE.<br/><br/>Valor predeterminado: 4096 (MB). | 
| HEAP\_MAX\_SIZE	| Solo perfil completo de WebSphere Application Server.<br/><br/>Dependiendo de la cantidad de datos de análisis que se generan, se necesita más memoria para manejar más datos. Defínalo para permitir un tamaño máximo de almacenamiento dinámico mayor para el perfil completo de WebSphere Application Server. Asegúrese de que el tamaño de memoria especificado en el componente Core OS de {{ site.data.keys.mf_analytics }} es mayor. Se recomienda establecer el mismo valor que HEAP_MIN_SIZE.<br/><br/>Valor predeterminado: 4096 (MB). | 
| WAS\_admin\_user | Solo perfil completo de WebSphere Application Server.<br/><br/>Usuario de administración de perfil completo de WebSphere Application Server para el servidor de analítica. Para el perfil de Liberty de WebSphere Application Server, deje el valor sin cambiarlo. | 
| WAS\_admin\_password | Solo perfil completo de WebSphere Application Server.<br/><br/>Contraseña de usuario de administración de perfil completo de WebSphere Application Server para el servidor de analítica. Para el perfil de Liberty de WebSphere Application Server, deje el valor sin cambiarlo. | 
...
| LDAP_TYPE | (Parámetro LDAP) Obligatorio. Tipo de servidor LDAP del registro de usuarios:<br/><br/>None<br/>La conexión LDAP está inhabilitada. Cuando está establecido, los demás parámetros de LDAP se tratan solo como marcadores.<br/><br/>TivoliDirectoryServer<br/>Seleccione este valor si el repositorio de LDAP es un IBM Tivoli  Directory Server.<br/><br/>ActiveDirectory<br/>Seleccione este valor si el directorio de LDAP es un Microsoft Active Directory.<br/><br/>Valor predeterminado: None.| 
...
| mfpadmin | (Parámetro de LDAP) Rol de administrador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
| mfpdeployer | (Parámetro de LDAP) Rol de desplegador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
| mfpmonitor | (Parámetro de LDAP) Rol de supervisor para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
| mfpoperator | (Parámetro de LDAP) Rol de operador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
...
| profile_name | Opcional. El nombre del perfil que contiene los archivos del entorno de tiempo de ejecución de WebSphere Application Server.<br/><br/>En las plantillas de patrón, se correlaciona con el atributo de salida **dmgr\_profile\_name** del gestor de despliegue o sa_profile_name del servidor autónomo. | 
...
| Ports	|Obligatorio. Otros puertos que deben abrirse para conectarse con el servidor DB2 y el servidor LDAP (opcional). Los valores de puerto pueden separarse por punto y coma; por ejemplo, '50000;636'<br/><br/>Default value: 50000. | 
...
| LDAP\_REPOSITORY\_NAME | (Parámetro LDAP) Nombre de servidor LDAP. | 
| CERT\_FILE\_PATH | (Parámetro LDAP) Vía de acceso de destino de la certificación de servidor LDAP cargada. Obligatorio cuando REQUIRE_SSL se establece en true. | 
| mfpadmin | Rol de administración para {{ site.data.keys.mf_server }}. Uno de los siguientes valores:<br/><br/>None<br/>Ningún usuario.<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None. | 
| mfpdeployer | (Parámetro de LDAP) Rol de desplegador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
| mfpmonitor | (Parámetro de LDAP) Rol de supervisor para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
| mfpoperator | (Parámetro de LDAP) Rol de operador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>Ningún usuario<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>Todos los usuarios.<br/><br/>Valor predeterminado: None.| 
...
| db_ip | Dirección IP del servidor DB donde está instalada la base de datos de administración. Está correlacionado con el atributo de salida IP del paquete script del componente de software del servidor de base de datos en la plantilla de patrón. | 
| db_port | Número de puerto del servidor DB donde está instalada la base de datos de administración. Está correlacionado con el atributo de salida instancePort del paquete script del componente de software del servidor de base de datos en la plantilla de patrón.|
| admin_user | Nombre de usuario que tiene el privilegio de administración de {{ site.data.keys.mf_server }}.<br/><br/>En la plantilla de patrón, está asociado con el parámetro con el mismo nombre en el paquete script de MFP Server Administration como un parámetro a nivel de patrón para asegurarse de que están establecidos en el mismo valor | 
| admin_password | contraseña del usuario administrador.<br/><br/>In En la plantilla del patrón, está asociada al parámetro del mismo nombre del paquete de scripts de MFP Server Administration como parámetro de nivel de patrón para garantizar que se establecen en el mismo valor. | 
| WAS\_admin\_user | Obligatorio para WebSphere Application Server. Opcional para WebSphere Application Server Liberty. Cuando {{ site.data.keys.mf_server }} se despliega en un perfil completo de WebSphere Application Server, se correlaciona con el atributo was_adminoutput del servidor autónomo en la plantilla de patrón.<br/><br/>Cuando {{ site.data.keys.mf_server }} se despliega en WebSphere Application Server Network Deployment, se correlaciona con el atributo de salida was_admin del gestor de despliegue en la plantilla de patrón. | 
...
| Parámetro | Descripción |
|-----------|-------------|
| None | Sin parámetros para este paquete script. | 
