...
| Nodo | Componentes | 
|------|------------|
| MobileFirst Platform Server |**Servidor de perfil de Liberty**<br/>Instalación del servidor de perfil de Liberty de WebSphere Application Server.<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>Aplicación web de administración de {{ site.data.keys.mf_server }} incluido
{{ site.data.keys.mf_console }}.<br/>**MFP Server Runtime Deployment**<br/>Configuración de la raíz de contexto de tiempo de ejecución.<br/><br/>**MFP Server Application**<br/>Aplicación de {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**MFP Server Adapter**<br/>. Un adaptador que se va a añadir al despliegue.<br/><br/>**despliegue de adaptador de aplicación de MFP Server**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración MobileFirst.<br/><br/>**MFP Runtime DB**<br/>Instalación del esquema de base de datos de tiempo de ejecución de {{ site.data.keys.product }}.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
...
| MobileFirst Platform Server |**Servidor de perfil de Liberty**<br/>Instalación del servidor de perfil de Liberty de WebSphere Application Server.<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>Aplicación web de administración de {{ site.data.keys.mf_server }} incluido
{{ site.data.keys.mf_console }}.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración de la raíz de contexto de tiempo de ejecución.<br/><br/>**MFP Server Application**<br/>Aplicación de {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**MFP Server Adapter**<br/>Un adaptador que se va a añadir al despliegue.<br/><br/>**despliegue de adaptador de aplicación de MFP Server**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}. <br/><br/>**Política de escalado base**<br/>Política de escalado de VM: número de VM. | 
| MobileFirst Platform DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración de {{ site.data.keys.product_adj }}.<br/><br/>**MFP Runtime DB**<br/>Instalación del esquema de base de datos de tiempo de ejecución de {{ site.data.keys.product }}.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
...
| Nodo | Componentes | 
|------|------------|
| MobileFirst Platform Server |**Servidor autónomo**<br/>Instalación del servidor de perfil completo de WebSphere Application Server.<br/><br/>Restricción:<br/>No cambie los valores de los atributos de componentes siguientes: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si cambia alguno de estos atributos de componente, el despliegue de patrones basado en estas plantillas fallará.<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>Aplicación web de administración de {{ site.data.keys.mf_server }} incluido {{ site.data.keys.mf_console }}.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración de la raíz de contexto de tiempo de ejecución.<br/><br/>**Aplicación {{ site.data.keys.product_adj }} **<br/>Aplicación de {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**Adaptador {{ site.data.keys.product_adj }}**<br/>Adaptador {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de la aplicación y el adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración de {{ site.data.keys.product_adj }}. <br/><br/>**MFP Runtime DB**<br/>Instalación del esquema de base de datos de tiempo de ejecución de {{ site.data.keys.product }}.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
...
|------|------------|
| IHS Server | **IBM HTTP servers**<br/>Instalación de IBM HTTP Server.<br/><br/>**MFP IHS Configuration**<br/>Configuración automática de IBM HTTP Server. | 
| MobileFirst Platform Server |**Servidor autónomo**<br/>Instalación del servidor de perfil completo de WebSphere Application Server.<br/><br/>Restricción: No cambie los valores de los atributos de los componentes siguientes: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si cambia alguno de estos atributos de componente, el despliegue de patrones basado en estas plantillas fallará.<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>Aplicación web de administración de {{ site.data.keys.mf_server }} incluido {{ site.data.keys.mf_console }}.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración de la raíz de contexto de tiempo de ejecución.<br/><br/>**Aplicación {{ site.data.keys.product_adj }} **<br/>Aplicación de {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**Adaptador {{ site.data.keys.product_adj }} **Un adaptador que se ha de añadir al despliegue.<br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de la aplicación y el adaptador en {{ site.data.keys.mf_server }}. <br/><br/>**Política de escalado base**<br/>Política de escalado de VM: número de VM. | 
| MobileFirst Platform DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración de {{ site.data.keys.product_adj }}. <br/><br/>**MFP Runtime DB**<br/>Instalación del esquema de base de datos de tiempo de ejecución de {{ site.data.keys.product }}.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
...
|------|------------|
| IHS Server | **IBM HTTP servers**<br/>Instalación de IBM HTTP Server.<br/><br/>**MFP IHS Configuration**<br/>Configuración automática de IBM HTTP Server. | 
| DmgrNode | **Gestor de despliegue**<br/>Instalación del gestor de despliegue de WebSphere Application Server.<br/><br/>Restricción: no modifique los valores de los siguientes atributos del componente: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si cambia alguno de estos atributos de componente, el despliegue de patrones basado en estas plantillas fallará.<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>Aplicación web de administración de {{ site.data.keys.mf_server }} incluido {{ site.data.keys.mf_console }}.<br/><br/>**MFP Runtime**<br/>Archivo WAR de tiempo de ejecución.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración de la raíz de contexto de tiempo de ejecución.<br/><br/>**Aplicación MFP**<br/>Aplicación de {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**Adaptador MFP**<br/>Un adaptador que se va a añadir al despliegue.<br/><br/>**despliegue de adaptador de aplicación de MFP Server**<br/>Despliegue de aplicación y de adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración de {{ site.data.keys.product_adj }}. <br/><br/>**MFP Runtime DB**<br/>Instalación del esquema de base de datos de tiempo de ejecución de {{ site.data.keys.product }}.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
...
|------|------------|
| MFP AppCenter DB | **Servidor de bases de datos**<br/>Instalación del servidor de bases de datos DB2.<br/><br/>**Default add disk**<br/>Configuración de tamaño de disco. | 
| MFP AppCenter Server |**Servidor autónomo**<br/>Instalación del servidor de perfil completo de WebSphere Application Server.<br/><br/>Restricción: No cambie los valores de los atributos de los componentes siguientes: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si cambia alguno de estos atributos de componente, el despliegue de patrones basado en estas plantillas fallará.<br/><br/>**MFP WAS SDK Level**<br/>La finalidad de este script es establecer el nivel de SDK necesario para el perfil WAS<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Application Center**<br/>Este paquete script configura el servidor {{ site.data.keys.mf_app_center }} en un perfil completo de WebSphere Application Server o en un perfil de Liberty de WebSphere Application Server. | 
...
| mfpadmin | (Parámetro LDAP) Rol Admin para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>        Sin usuario.<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>        Todos los usuarios.<br/><br/>Valor predeterminado: None. | 
| mfpdeployer | (Parámetro LDAP) Rol Desplegador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>        Sin usuario.<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>        Todos los usuarios.<br/><br/>Valor predeterminado: None. | 
| mfpmonitor | (Parámetro LDAP) Rol Supervisor para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>        Sin usuario.<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>        Todos los usuarios.<br/><br/>Valor predeterminado: None. | 
| mfpoperator | (Parámetro LDAP) Rol Operador para {{ site.data.keys.mf_server }}:<br/><br/>None<br/>        Sin usuario.<br/><br/>AllAuthenticatedUsers<br/>Usuarios autenticados<br/><br/>Everyone<br/>        Todos los usuarios.<br/><br/>Valor predeterminado: None. | 
