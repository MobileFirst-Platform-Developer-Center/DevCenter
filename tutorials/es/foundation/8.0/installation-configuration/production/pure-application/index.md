...
|------|------------|
| IHS Server | **IBM HTTP servers**<br/>Instalación de IBM HTTP Server.<br/><br/>**MFP IHS Configuration**<br/>Configuración automática de IBM HTTP Server. | 
| DmgrNode | **Gestor de despliegue**<br/>Instalación del gestor de despliegue de WebSphere Application Server.<br/><br/>Restricción: No cambie los valores de los atributos de los componentes siguientes: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si cambia alguno de estos atributos de componente, el despliegue de patrones basado en estas plantillas fallará.<br/><br/>**Requisito previo de MFP Server**<br/>Requisitos previos para la instalación de {{ site.data.keys.mf_server }} incluidos SSL y Ant.<br/><br/>**MFP Server Administration**<br/>Aplicación web de administración de {{ site.data.keys.mf_server }} incluido {{ site.data.keys.mf_console }}.<br/><br/>**MFP Runtime**<br/>Archivo WAR de tiempo de ejecución.<br/><br/>**MFP Server Runtime Deployment**<br/>Configuración de la raíz de contexto de tiempo de ejecución.<br/><br/>**Aplicación MFP**<br/>Aplicación de {{ site.data.keys.product_adj }} que se ha de añadir al despliegue.<br/><br/>**Adaptador MFP**<br/>Un adaptador que se ha de añadir al despliegue. <br/><br/>**MFP Server Application Adapter Deployment**<br/>Despliegue de la aplicación y el adaptador en {{ site.data.keys.mf_server }}. | 
| MobileFirst Platform DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**MFP Administration DB**<br/>Instalación del esquema de base de datos de administración de {{ site.data.keys.product_adj }}. <br/><br/>**MFP Runtime DB**<br/>Instalación del esquema de base de datos de tiempo de ejecución de {{ site.data.keys.product }}.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
| CustomNode | **Nodos personalizados**<br/>Detalles de las celdas y nodos de los clústeres de los servidores de WebSphere Application Server Network Deployment.<br/><br/>Restricción: No cambie los valores de los atributos de los componentes siguientes: {::nomarkdown}<ul><li>Nombre de celda</li><li>Nombre de nodo</li><li>Nombre de perfil</li></ul>{:/}Si cambia alguno de estos atributos de componente, el despliegue de patrones basado en estas plantillas fallará.<br/><br/>**MFP Open Firewall Ports for WAS**<br/>Los puertos que deben estar abiertos para habilitar la conexión con el servidor de base de datos y el servidor LDAP.<br/><br/>**Política de escalado base**<br/>Número de instancias de máquina virtual necesarias para la topología elegida. | 
...
| Nodo | Componentes |
|------|------------|
| MFP AppCenter DB | **Servidor de base de datos**<br/>Instalación del servidor de base de datos DB2.<br/><br/>**Adición de disco predeterminada**<br/>Configuración del tamaño de disco. | 
