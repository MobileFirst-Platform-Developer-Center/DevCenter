...
{{site.data.keys.product }} tiene un número de requisitos del sistema que debe satisfacer para instalar y configurar el producto satisfactoriamente.
Los requisitos del sistema incluyen los siguientes elementos:
