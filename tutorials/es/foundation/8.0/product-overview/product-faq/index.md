...
Este tema describe la lista de preguntas más frecuentes relacionadas con IBM Mobile Foundation.

<div class="panel-group accordion" id="mfp-product-faqs" role="tablist">
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq1">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq1" aria-expanded="true" aria-controls="collapse-mfp-faq1"><b>1.	¿Cuál es la política de soporte para Mobile Foundation v8.0?</b></a>
            </h4>
        </div>
...
.</p>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq2">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq2" aria-expanded="true" aria-controls="collapse-mfp-faq2"><b>2. ¿Dónde puedo obtener información relativa a los iFixes y actualizaciones de entrega continua para Mobile Foundation?</b></a>
            </h4>
        </div>
        <div id="collapse-mfp-faq2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mfp-faq2">
            <div class="panel-body">
                  <p>Puede encontrar información sobre la lista de todos los iFixes y actualizaciones de entrega continua publicados para Mobile Foundation v8.0 <a href="https://mobilefirstplatform.ibmcloud.com/blog/2018/05/18/8-0-master-ifix-release/" target="_blank">aquí</a>.</p>
            </div>
        </div>      
    </div>
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq3">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq3" aria-expanded="true" aria-controls="collapse-mfp-faq3"><b>3. ¿Cuál es la lista de características publicadas con las actualizaciones de entrega continua de Mobile Foundation v8.0?</b></a>
            </h4>
        </div>
        <div id="collapse-mfp-faq3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="mfp-faq3">
            <div class="panel-body">
                  <p>Puede ver la lista de características publicadas en las actualizaciones de entrega continua de Mobile Foundation v8.0 desde <a href="{{site.baseurl}}/tutorials/en/foundation/8.0/product-overview/release-notes/interim-fixes/">aquí</a>.</p>
            </div>
        </div>      
    </div>
   <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="mfp-faq4">
            <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#mfp-product-faqs" href="#collapse-mfp-faq4" aria-expanded="true" aria-controls="collapse-mfp-faq4"><b>4. ¿Dónde puedo obtener más información sobre IBM Mobile Foundation en IBM Cloud Private (ICP)?</b></a>
            </h4>
        </div>
