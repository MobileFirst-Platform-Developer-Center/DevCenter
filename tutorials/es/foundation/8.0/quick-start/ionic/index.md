...
3. En el proyecto Ionic, seleccione el archivo **config.xml** y edite el valor `<mfp:server ... url=" "/>` con las propiedades **protocol**, **host** y **port** con los valores adecuados para su {{ site.data.keys.mf_server }}.
