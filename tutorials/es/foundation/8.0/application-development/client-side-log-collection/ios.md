...
> **Nota:** Adopte el siguiente patrón al recopilar datos de registro. El envío de datos de forma periódica garantiza que está viendo sus datos de registro en tiempo casi real en {{ site.data.keys.mf_analytics_console }}.
