...
> **注：**[不再](https://crosswalk-project.org/blog/crosswalk-final-release.html)由社区及其维护者维护 CrossWalk 项目。因此，CrossWalk 中的错误或问题可能会影响 CrossWalk WebView 中 MobileFirst SDK 的运行。因此，不建议在应用程序中使用 CrossWalk WebView。 
