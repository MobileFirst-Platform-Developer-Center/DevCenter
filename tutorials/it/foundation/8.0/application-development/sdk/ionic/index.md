---
layout: tutorial
title: Adding the MobileFirst Foundation SDK to Ionic Applications
...
## Overview
{: #overview }
In this tutorial, you learn how to add the {{ site.data.keys.product_adj }} SDK to a new or existing Ionic application, created using Ionic CLI. You also learn how to configure the {{ site.data.keys.mf_server }} to recognise the application and to find information about the {{ site.data.keys.product_adj }} configuration files that are changed in the project.

The {{ site.data.keys.product_adj }} Ionic SDK is provided as a set of Typescript Wrappers along with the Cordova plug-ins and is registered at [NPM](https://www.npmjs.com/package/cordova-plugin-mfp).  
...
### Jump to:
{: #jump-to }
- [Ionic SDK components](#ionic-sdk-components)
- [Adding the {{ site.data.keys.product_adj }} Ionic SDK](#adding-the-mobilefirst-ionic-sdk)
- [Updating the {{ site.data.keys.product_adj }} Ionic SDK](#updating-the-mobilefirst-ionic-sdk)
- [Generated {{ site.data.keys.product_adj }} Ionic SDK artifacts](#generated-mobilefirst-ionic-sdk-artifacts)
...
- [Ionic CLI](https://www.npmjs.com/package/ionic) and {{ site.data.keys.mf_cli }} installed on the developer workstation.
...
## Adding the {{ site.data.keys.product }} Ionic SDK
{: #adding-the-mobilefirst-ionic-sdk }
Follow the instructions below to add the {{ site.data.keys.product }} Ionic SDK to a new or existing Ionic project, and register it in the {{ site.data.keys.mf_server }}.
...
### Adding the SDK
{: #adding-the-sdk }
Consider creating the project by using the {{ site.data.keys.product_adj }} Ionic **application template**. The template adds the necessary {{ site.data.keys.product_adj }}-specific plug-in entries to the Ionic project's **config.xml** file, and provides a {{ site.data.keys.product_adj }}-specific, ready-to-use, **index.js** file that is adjusted for {{ site.data.keys.product_adj }} application development.
...
4. Prepare the application resources by running the `ionic cordova prepare command`:
...
Navigate to the root of your existing Ionic project and add the {{ site.data.keys.product_adj }} core Ionic Cordova plug-in:

   ```bash
   ionic cordova plugin add cordova-plugin-mfp
   ```

The {{ site.data.keys.product_adj }} API methods are available after the {{ site.data.keys.product_adj }} client SDK has been loaded. The `mfjsloaded` event is then called.  
...
The `mfpdev app register` CLI command first connects to the {{ site.data.keys.mf_server }} to register the application, then updates the **config.xml** file at the root of the Ionic project with metadata that identifies the {{ site.data.keys.mf_server }}.
...
## Generated {{ site.data.keys.product_adj }} Ionic SDK artifacts
...
After the {{ site.data.keys.product_adj }} Ionic SDK is added to the project, the Ionic-generated **config.xml** file receives a set of new elements that are identified with the namespace `mfp:`. The added elements contain information related to {{ site.data.keys.product_adj }} features and the {{ site.data.keys.mf_server }}.
...
{: #tutorials-to-follow-next }
With the {{ site.data.keys.product_adj }} Ionic SDK now integrated, you can now:
