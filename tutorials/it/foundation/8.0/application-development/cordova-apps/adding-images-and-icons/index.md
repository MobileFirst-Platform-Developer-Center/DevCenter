...
8. Modify your `AppDelegate.m` as below and build and run the application. Now instead of the black splashscreen, a white screen will appear and this can be customized in *ViewController.storyboard* .
