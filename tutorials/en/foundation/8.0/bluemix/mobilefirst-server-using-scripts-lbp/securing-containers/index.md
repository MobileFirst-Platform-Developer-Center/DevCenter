...
2. Modify the **mfpf-server-libertyapp/usr/config/keystore.xml** and **appcenter/usr/config/keystore.xml** (for appcenter) file similar to the following example configuration:
