---
layout: tutorial
title: Administrating MobileFirst applications through the MobileFirst Operations Console
breadcrumb_title: Administrating MobileFirst applications through the console
weight: 2
---
## Overview
...
* Secure mode for production or test: [https://hostname:secure_port/mfpconsole](https://hostname:secure_port/mfpconsole)
* Development: [http://server_name:port/mfpconsole](http://server_name:port/mfpconsole)
