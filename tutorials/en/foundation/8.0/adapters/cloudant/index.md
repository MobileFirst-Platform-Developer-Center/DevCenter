...
---
## Overview
Cloudant is a NoSQL Database based on CouchDB, which is available as a stand-alone installed product and as a Database-as-a-Service (DBaaS) on IBM Bluemix and `cloudant.com`.
