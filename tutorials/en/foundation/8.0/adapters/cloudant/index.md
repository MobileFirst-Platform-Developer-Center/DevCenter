 ...
 * CloudantJS:
  ...
  3. Use either Maven or MobileFirst Developer CLI to [build and deploy the CloudantJS adapter](../creating-adapters/).

 * CloudantJava:
  1. Use either Maven or MobileFirst Developer CLI to [build and deploy the CloudantJava adapter](../creating-adapters/).
