...
The cordova-plugin-mfp-jsonstore plug-in enables your app to use JSONstore. For more information about JSONstore, see the [JSONStore tutorial](../../app-dev/jsonstore/cordova/).  
...
1. Create a Cordova project:
    ...
    > The templated **index.js** enables you to use additional MobileFirst features as such [Multilingual application  translation](../../app-dev/translation) and initialization options (see the user documentation for more information).
...
2. Register the application to MobileFirst Server:
    ...
    mfpdev app register
    ```
    - If a remote server is used, [use the command `mfpdev server add`](../../app-dev/using-mobilefirst-cli-to-manage-mobilefirst-artifacts/#add-a-new-server-instance) to add it.
