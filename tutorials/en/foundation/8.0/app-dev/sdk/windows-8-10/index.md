...
2. Run the command:
    ...
    mfpdev app register
    ```
    - If you use a remote server, [use the command `mfpdev server add`](../../app-dev/using-mobilefirst-cli-to-manage-mobilefirst-artifacts/#add-a-new-server-instance) to add it.
