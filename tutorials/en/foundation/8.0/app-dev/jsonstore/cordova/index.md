...
* Make sure the MobileFirst Cordova SDK was added to the project. Follow the [Adding the MobileFirst Foundation SDK to Cordova applications](../../../app-dev/sdk/cordova/) tutorial. 
