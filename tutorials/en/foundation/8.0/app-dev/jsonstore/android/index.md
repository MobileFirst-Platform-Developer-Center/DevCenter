...
* Make sure the MobileFirst Native SDK was added to the Android Studio project. Follow the [Adding the MobileFirst Foundation SDK to Android applications](../../../app-dev/sdk/android/) tutorial.
