...
- If you are implementing a Cordova application, ensure you have [added the MobileFirst Platform SDK](../../../app-dev/sdk/cordova) to your Cordova application.
- If you are implementing a Web application, ensure you have [added the MobileFirst Platform SDK](../../../app-dev/sdk/web) to your Web application.
