...
IBM MobileFirst Foundation provides an SDK in the form of several Cordova plug-ins. Learn how to [Add the MobileFirst Foundation SDK to Cordova applications](../../app-dev/sdk/cordova).
...
## MobileFirst APIs
After [adding the MobileFirst Cordova SDK](../../app-dev/sdk/cordova) to a Cordova application, the MobileFirst set of API methods is now available for use.
...
Get started by [adding the MobileFirst SDK to your Cordova application](../../app-dev/sdk/cordova), and review MobileFirst-provided features in the [All Tutorials](../../all-tutorials/) section.
