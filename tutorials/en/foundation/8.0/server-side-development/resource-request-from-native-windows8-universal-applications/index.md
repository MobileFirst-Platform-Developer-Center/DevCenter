...
<span style = "color:red">To create and configure a Windows 8 (Universal) native project, first follow the <a href="../">Configuring a native Windows 8 application with the MobileFirst Platform SDK</a> tutorial.</span>
