...
Remember that SQL adapters require a JDBC connector driver. [Follow this instructions to add the JDBC connector dependency](http://blog.valdaris.com/post/custom-jar/) .
