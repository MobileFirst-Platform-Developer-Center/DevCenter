...
* Make sure you have read the following tutorials:
    ...
    * [Adding the MobileFirst Foundation SDK to Android applications](../../../app-dev/sdk/android)
...
If the MobileFirst Native Android SDK is not already present in the project, follow the instructions in the [Adding the MobileFirst Foundation SDK to Android applications](../../../app-dev/sdk/android) tutorial.
