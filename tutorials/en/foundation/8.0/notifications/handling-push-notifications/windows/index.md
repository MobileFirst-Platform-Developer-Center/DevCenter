...
* Make sure you have read the following tutorials:
    ...
    * [Adding the MobileFirst Platform Foundation SDK to windows applications](../../../app-dev/sdk/windows-8-10)
...
If the MobileFirst Native Windows SDK is not already present in the project, follow the instructions in the [Adding the MobileFirst Foundation SDK to Windows applications](../../../app-dev/sdk/windows-8-10) tutorial.
