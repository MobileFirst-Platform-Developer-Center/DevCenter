...
| `WL.Client.logActivity(activityType)` | [`WL.Logger` を使用してください。](http://www.ibm.com/support/knowledgecenter/en/SSHS8R_8.0.0/com.ibm.worklight.apiref.doc/html/refjavascript-client/html/WL.Logger.html?view=kc) |
